...
<div class="app-content-header">
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-sm-6"><h5 class="mb-2">Upload Regional</h5></div>
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ route('regional') }}">Regional</a></li>
        ...
        <div class="col-8">
            <div class="card card-success card-outline mb-4">
                <div class="card-header d-flex  align-items-center">
                    <h5 class="mb-0">Upload Regional</h5>
                    <a href="{{ route('regional.template') }}" class="btn btn-primary btn-sm ms-auto">
                ...
                <form action='javascript:void(0)' enctype="multipart/form-data" id="form_data">
                    ...
                    <div class="card-footer">
                      <a href="{{ route('project') }}" class="btn btn-danger btn-flat btn-sm"><i class="fa fa-mail-reply"></i> Kembali</a>
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if(result.status == "success"){
                    ...
                    setTimeout(() => {
                        window.location.href = "{{ route('regional') }}";
                    }, 2000);
