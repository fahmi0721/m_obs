...
<div class="app-content-header">
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-sm-6"><h5 class="mb-2">Jabatan</h5></div>
        <div class="col-sm-6">
        ...
        <div class="col-12">
            <div class="card card-success card-outline mb-4">
                <div class="card-header d-flex  align-items-center">
                    ...
                    <a href="{{ route('job.create') }}" class="btn btn-success btn-sm ms-auto">
...
load_data = function(){
    $('#tb_data').DataTable({
        ...
        columns: [
            ...
            { data: 'job_id_tanos', name: 'job_id_tanos' },
            { data: 'nama', name: 'nama' },
        ]
    });
