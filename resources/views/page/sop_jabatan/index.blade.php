...
<div class="app-content-header">
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-sm-6"><h5 class="mb-2">SOP Jabatan</h5></div>
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">SOP Jabatan</li>
        </ol>
        </div>
    </div>
    <!--end::Row-->
        ...
        <div class="col-12">
            <div class="card card-success card-outline mb-4">
                <div class="card-header d-flex  align-items-center">
                    ...
                    <a href="{{ route('sop_jabatan.create') }}" class="btn btn-success btn-sm ms-auto">
...
load_data = function(){
    $('#tb_data').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "{{ route('sop_jabatan') }}",
        columns: [
            { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
            { data: 'nama_sop', name: 'nama_sop' },
            { data: 'nama_job', name: 'nama_job', orderable: false, searchable: false },
