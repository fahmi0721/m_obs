@extends('layouts.app')
@section('title','Create SOP Jabatan')
@section('breadcrumb')
<div class="app-content-header">
    ...
    <div class="row">
        ...
        <ol class="breadcrumb float-sm-end">
            ...
            <li class="breadcrumb-item active" aria-current="page">Create New SOP Jabatan</li>
        </ol>
        </div>
    </div>
    <!--end::Row-->
        ...
        <div class="col-8">
            <div class="card card-success card-outline mb-4">
                <div class="card-header d-flex  align-items-center">
                    <h5 class="mb-0">Create SOP SOP Jabatan</h5>
                </div>
                <!--end::Header-->
                <!--begin::Form-->
