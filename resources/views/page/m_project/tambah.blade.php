...
<div class="app-content-header">
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-sm-6"><h5 class="mb-2">Upload Project</h5></div>
        <div class="col-sm-6">
        ...
        <div class="col-8">
            <div class="card card-success card-outline mb-4">
                <div class="card-header d-flex  align-items-center">
                    <h5 class="mb-0">Upload Project</h5>
                    <a href="{{ route('project.template') }}" class="btn btn-primary btn-sm ms-auto">
